    ...
    public partial class AddEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotographerRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PhotographerRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.PhotoId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotoAlbumItems", x => new { x.GalleryId, x.PhotoId });
                    table.ForeignKey(
                        name: "FK_PhotoAlbumItems_Galleries_GalleryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhotographerRequests_UserId",
